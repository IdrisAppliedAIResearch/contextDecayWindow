"""Execute DMR-001 PF1-PF10 and write the committed preflight artifact."""
...
from src.analysis.dmr001_preflight import build_preflight  # noqa: E402

STUDY = ROOT / "experiments" / "components" / "biological_memory" / "dmr_001"
DEFAULT_DESIGN = STUDY / "DMR_001_FINAL_DESIGN.json"
DEFAULT_OUTPUT = STUDY / "artifacts" / "dmr001_preflight" / "preflight.json"
...
def main() -> int:
    ...
    for failure in report["failed_checks"]:
        ...
        print(f"      observed {failure['observed']!r} expected {failure['expected']!r}")
