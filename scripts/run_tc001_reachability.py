#!/usr/bin/env python
"""Run TC-001 Preflight PF4: are the bars reachable and failable?

    python scripts/run_tc001_reachability.py \
...
from analysis.tc001_reachability import measure  # noqa: E402
