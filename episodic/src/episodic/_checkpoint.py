"""Atomic, auditable checkpoints for long runs.

Moved as-is from the source repository's Study 010 incident path
(`src/study/checkpoint.py`). This code has survived exactly one 1,000-turn
run; hardening it into a tested guarantee is deliberately out of scope
here (CC-004).
"""
