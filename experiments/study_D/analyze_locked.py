...
def main():
    ...
    for typ in types:
        ...
        by_type[typ]={'queries':32,'accuracy':{a:rate(a,[typ]) for a in arms},'complete_evidence':None if typ=='N1' else {a:sum(t['availability'][a]['complete'] for t in subset) for a in arms}}
    conditional={}
    for arm in ('C0','C1'):
