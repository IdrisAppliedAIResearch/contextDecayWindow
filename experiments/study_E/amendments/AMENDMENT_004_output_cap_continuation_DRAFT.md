# Amendment 004 draft: bounded output-cap continuation

2026-09-06. **DRAFT FOR AUTHORIZATION — no continuation implementation or inference authorized by this draft.** Same Study E, same population and PR. Do not alter the locked registration or original capture.
...
The registration explicitly prohibits automatic cap increases and requires a separately authorized continuation amendment. This draft proposes that repair; it does not claim that a larger cap will make the model finish.
