# AF-READ-002 unattended sequence: pilot -> full -> judge -> score.
#
#   powershell -ExecutionPolicy Bypass -File experiments\probes\anchor_reader\run_all002.ps1
#
...
# Transcript: artifacts\af_read002\run_all.log
...
$script = "$dir\af_read002.py"
$art = "$root\$dir\artifacts\af_read002"
...
try {
    ...
    Write-Host '=== AF-READ-002 COMPLETE ===' -ForegroundColor Green
    Write-Host 'results: artifacts\af_read002\results.json'
}
catch {
