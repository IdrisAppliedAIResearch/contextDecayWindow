...
def main():
    ...
    lines=['# Post-review removal reader probe','','Plan5085934f; implementation82d82e90; inputgatee4038d78; calibration915cb214. Failure-selected diagnostic, no production change.','',
        ...
        'Canonical final-answer scoring plus carried user-authorized single-agent prose adjudication; no human or three-pass audit. Raw captures were committed before scores, resolved scores before this report. Negative input gate and parser fixtures and duplicate arithmetic45 calibration preceded inference.','',
