...
**TC-015 tests whether the two useful controls compose, and Part 1 stops it.**
Opportunity admission leaves every retained child able to fit its protected
half on all 1,742 cells. Utility sorting changes payload order but changes zero
selected identity sets at either budget. The availability endpoint is therefore
unreachable; no registration or labels were opened.
...
> **TC-015 opportunity then utility (2026-08-26).** Opportunity filtering
> leaves every retained child able to fit the spread half on 1,742/1,742 cells.
> Utility sorting changes payload order on 868/871 rows at 16k and 871/871 at
> 32k, but selected identities on 0/871 at both. `STOPPED_AT_PART_1;
> INERT_SELECTION`; no registration, labels or answers.
...
| TC-014 | Separately ablate parent-cosine binding, global one-to-one assignment, utility packing, exact semantic-opportunity admission, and combined T2+T3+T4 | CHARACTERIZED; TWO BUDGET-SPECIFIC COMPONENT SIGNALS; REGISTERED-OFFLINE | Opportunity versus TC-013 nets +7/+7/+3 combined/targeted/breadth at 16k and +5/+3/-1 at 32k; utility packing is -2/-1/0 at 16k and +1/0/+1 at 32k. Parent binding, matching and T234 are NO_HELP. Descriptive 32k opportunity totals 826/692/25 versus CC80 819/689/24, but that paired contrast was not registered. 3,484 controls, zero calls/misses; no answers/adoption |
| TC-015 | Apply TC-014 opportunity admission, then sort the retained children by frozen TC-013 edge utility before unchanged protected packing | STOPPED_AT_PART_1; INERT_SELECTION | Opportunity retains median 17/36 children at 16k/32k and every retained child fits the spread half on all 1,742 cells. Sorting changes payload order on 868/871 and 871/871 rows but selected identity sets on 0/871 at both budgets. PF4 makes evidence-availability movement unreachable; no pre-registration, labels, answers or adoption |
