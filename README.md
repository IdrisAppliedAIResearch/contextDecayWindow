...
> **TC-013 CC80-parent ASPECT fan-out (2026-08-25).** Every half-budget CC80
> admission gets one singleton-seeded ASPECT child attempt. Fan-out versus full
> CC80 combined is 763/771 at 16k and 821/819 at 32k; breadth is 16/17 and
> 26/24; targeted is 654/666 and 689/689. It beats global ASPECT at both
> budgets, but only beats CC80 at 32k. `BUDGET_SPECIFIC_SIGNAL`; CC80 fallback.

> **TC-014 traversal ablation (2026-08-25).** Versus TC-013, exact opportunity
> admission clears `HELPS` at 16k with combined/targeted/breadth nets +7/+7/+3;
> utility-first packing clears it at 32k with one combined/breadth gain and no
> losses. Parent binding, global assignment and T2+T3+T4 are `NO_HELP`.
> Opportunity totals 826 at 32k descriptively, but loses one breadth completion
> versus TC-013 and no opportunity-plus-utility combination is authorized.

> **LV-004 TC-014 live reader (2026-08-26).** On 16 registered answerable
> offline-discordant items, opportunity/full CC80 score 5/5. Opportunity gains
> one targeted item and loses one breadth item; combined net 0, targeted +1,
> breadth -1. The frozen breadth guardrail yields `REGRESSES`. Two balanced
> LV-003 truncations were completed with exact prefix identity before 480 blind
> judgments. Selected LoCoMo development only; no adoption or tuning.

> **LV-005/006 TC-014 context organization (2026-08-26).** With identical
> frozen opportunity evidence, flat/grouped/chronological/guided renderers score
> 5/6/6/6 on 16 selected items. Guided versus flat gains one breadth item with
> no losses (`WEAK_SIGNAL`), but guidance versus chronology is 0/0. Median block
> size grows 31,983->42,542 chars. No adoption or transfer.
...
| TC-013 | Give every half-budget CC80 admission one singleton-seeded ASPECT child attempt, then pack unique children under the protected half | CHARACTERIZED; BUDGET_SPECIFIC_SIGNAL; REGISTERED-OFFLINE | Fan-out/full-CC80 combined is 763/771 at 16k and 821/819 at 32k; breadth 16/17 and 26/24; targeted 654/666 and 689/689. Versus global static ASPECT, fan-out gains +14/+11 combined. Median proposals/admissions are 25/22 and 52/46. 3,484 control reproductions, zero calls/misses. 16k regresses and conversation nets are mixed; CC80 fallback |
| TC-014 | Separately ablate parent-cosine binding, global one-to-one assignment, utility packing, exact semantic-opportunity admission, and combined T2+T3+T4 | CHARACTERIZED; TWO BUDGET-SPECIFIC COMPONENT SIGNALS; REGISTERED-OFFLINE | Opportunity versus TC-013 nets +7/+7/+3 combined/targeted/breadth at 16k and +5/+3/-1 at 32k; utility packing is -2/-1/0 at 16k and +1/0/+1 at 32k. Parent binding, matching and T234 are NO_HELP. Descriptive 32k opportunity totals 826/692/25 versus CC80 819/689/24; LV-004 owns the selected live reader follow-up. 3,484 controls, zero calls/misses; no adoption |
| LV-004 | Live reader conversion of TC-014 opportunity admission versus full CC80 on their 32k offline-discordant questions | REGRESSES; REGISTERED LIVE | On 16 answerable selected LoCoMo development items, opportunity/full CC80 score 5/5: one targeted gain, one breadth loss, combined net 0. The locked breadth non-regression guardrail fires. Two balanced LV-003 truncations were completed at 2,048 tokens with byte-identical 512-token prefixes; 170/170 reader answers and 480/480 blind judgments pass. Both arms refuse the adversarial item 5/5. No overall benchmark, transfer, adoption or tuning claim |
| LV-005/006 | Frozen-evidence context organization: parent-child grouping, chronology, and conservative temporal guidance | WEAK_SIGNAL; REGISTERED LIVE | Flat/grouped/chronological/guided score 5/6/6/6 on 16 selected items. Guided vs flat gains one breadth item with no losses; guidance vs chronology is 0/0, so only the full bundle carries signal. Median block grows 31,983->42,542 chars. LV-006 regenerated all 960 blind judgments under one parse-safe instrument after LV-005 stopped; no adoption or transfer claim |
